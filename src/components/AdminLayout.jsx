...
import { LayoutDashboard, Users, FileText, LogOut, Menu, X, Shield, DollarSign, AlertTriangle } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/admin/error-reports', label: '错误报告', icon: AlertTriangle, end: false },
]
